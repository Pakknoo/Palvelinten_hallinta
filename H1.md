...
# a) Saltin asennus virtuaalikoneeseen
...
Minun piti ensin asentaa gpg-avain, jonka jälkeen asennus onnistui. Käytin sivuilta löytyneitä komentoja:
...
voi kerätä tietoa järjestelmästä. Komennon avulla tulostuu paljon tietoa muun muassa BIOSista, koneen käyttöjärjestelmästä, prosessorista, kernelistä (eli linuxin ytimestä), ip-osoitteesta.
